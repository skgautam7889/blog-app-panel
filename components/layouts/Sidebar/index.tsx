            ...
            <div className="scroll-sidebar">
                <div className="user-profile">
                    <div className="user-pro-body">
                        ...
                        <div className="dropdown">
                            <a href="#" className="dropdown-toggle u-dropdown link hide-menu"
                ...
                <nav className="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a className="has-arrow waves-effect waves-dark" href="#"
                                aria-expanded="false">
                        ...
                        <li>
                            <a className="has-arrow waves-effect waves-dark" href="#"
                                ...
                                <span className="hide-menu">Ui Elements
                                    <span className="badge rounded-pill bg-primary text-white ms-auto">25</span>
                                </span>
                            </a>
                            <ul aria-expanded="false" className="collapse">
                                <li>
                        ...
                        <li>
                            <a className="has-arrow waves-effect waves-dark" href="#"
                                ...
                                <span className="hide-menu">Sample Pages
                            ...
                            <ul aria-expanded="false" className="collapse">
                                ...
                                <li>
                                    <a href="#" className="has-arrow">Authentication
                                        <span className="badge rounded-pill bg-success pull-right">6</span>
                                    </a>
                                    <ul aria-expanded="false" className="collapse">
                                        <li>
                                ...
                                <li>
                                    <a href="#" className="has-arrow">Error Pages</a>
                                    <ul aria-expanded="false" className="collapse">
                                        <li>
